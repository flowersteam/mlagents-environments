...
_AGENTINFOPROTO = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='info_dict', full_name='communicator_objects.AgentInfoProto.info_dict', index=11,
